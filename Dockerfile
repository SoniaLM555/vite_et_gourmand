...
RUN apt-get update && apt-get install -y libicu-dev libonig-dev libxml2-dev && \
...
RUN DATABASE_URL=mysql://dummy:dummy@127.0.0.1/dummy php bin/console importmap:install
