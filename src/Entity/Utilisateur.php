...
class Utilisateur implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function getRoleObjet(): ?Role
    {
        return $this->role_objet;
    }

    public function setRoleObjet(?Role $role_objet): static
    {
        $this->role_objet = $role_objet;
